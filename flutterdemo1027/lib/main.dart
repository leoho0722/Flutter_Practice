    ...
    return SingleChildScrollView(
      child: Column(
        children: const [
          ...
          //   child: Row(
          //     children: const [
          //       Icon(Icons.access_alarm, color: Colors.blue, size: 36),
          ...
          //   child: Row(
          //     children: [
          //       const Icon(Icons.computer, color: Colors.red, size: 36),
          //       Container(
          ...
          //   child: Image.asset('assets/images/IU-1.jpg'),
          // )
        ],
      )
    );
...
class CenterTextView extends StatelessWidget {
  const CenterTextView({ Key? key }) : super(key: key);
